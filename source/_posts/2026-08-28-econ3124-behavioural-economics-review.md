---
title: ECON3124 行为经济学学了什么：从零基础冲刺到期末的完整复习笔记
...
ECON3124 是一门很容易被课程名称误解的课。它并不是把“人不理性”当成一句结论，而是在标准经济学模型之上，系统追问三个问题：人的偏好究竟如何偏离标准模型？人的信念为什么会系统性出错？当这些人互相博弈时，市场结果和公共政策又会发生什么变化？

我复习这门课时几乎是从零开始，原本制定了一周计划，后来可用时间一度被压缩到接近一天。这个过程迫使我放弃“从第一页重新读到最后一页”的安全感，改用概念识别、公式建模、独立做题、错误诊断和定向重测的循环。下面既是一份课程知识地图，也是一篇关于如何复习行为经济学的复盘。
...
## 十、我的冲刺复习方法：不再追求“看完”，而是追求“能识别”

原计划是一周从 Lecture 1 复习到 Lecture 16：前三天覆盖风险、时间偏好、信念与启发式；中间两天处理博弈论和社会偏好；最后两天完成有限推理、学习、政策与模拟题。后来时间被压缩，我不得不重新排序。
...
对复习本身也是如此：真正的进步并不来自“今天看了多少页”，而来自能否在新题里识别机制、写出正确模型、解释结果，并知道自己上一次究竟错在哪里。对我而言，这正是从零基础冲刺 ECON3124 后最值得保留下来的经验。
