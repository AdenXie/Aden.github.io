...
async function main() {
  ...
  fs.writeFileSync(path.join(ROOT, 'public/vercel.json'), JSON.stringify({ regions: ['hnd1'], git: { deploymentEnabled: { source: false, 'exchange-rates': false } }, functions: { 'api/chat.js': { maxDuration: 65 } } }, null, 2));
